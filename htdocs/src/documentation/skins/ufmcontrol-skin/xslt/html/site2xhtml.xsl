...
$Id: site2xhtml.xsl,v 1.2 2004/01/03 09:10:22 nivit Exp $
-->
...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:variable name="menu-border" select="'#CDCDC9'"/>
  <xsl:variable name="background-bars" select="'#E4E4E0'"/>
  ...
  <xsl:template match="site">
    ...
    <table cellspacing="0" cellpadding="0" border="0" width="100%" summary="navigation path">
      ...
      <tr>
        <td height="10" bgcolor="{$menu-border}"><img src="{$spacer}" border="0" alt="" width="2" height="2" /></td>
      </tr>
    </table>
    ...
    <table cellspacing="0" cellpadding="0" border="0" width="100%" summary="header with logos">
      <tr>
        ...
        <td bgcolor="{$header-color}" align="center" width="50%">
        ...
        <td bgcolor="{$header-color}" width="33%" height="80" align="center">
...
<!-- Align host-logo         <div class="host"> -->
            <img src="{$root}skin/images/spacer.gif" width="10" height="1" alt=""/>
            <xsl:call-template name="renderlogo">
